public class Main {
    public static void main(String[] args) {
        ...
        if (args.length == 3) {
            ...
            System.out.println("Rowananie:");
            double delta = b * b - 4 * a * c;
            if (Double.compare(delta, 0.0) == 0) {
                System.out.println("x = " + (-b / 2 * a));
            } else if (delta < 0.0) {
                System.out.println("x1 = " + new Complex(-b / 2 * a, (-Complex.sqrt(delta).getIm()) / 2 * a));
                System.out.println("x2 = " + new Complex(-b / 2 * a, (Complex.sqrt(delta).getIm()) / 2 * a));
            } else {
...
//        Wykorzystanie metod zwracających wynik obliczeń:
        ...
        System.out.println("c1.equals(null) = " + c1.equals(null)); // c1.equals(null) = false
        System.out.println("c1.equals(\"test ze zlym obiektem\") = " + c1.equals("test ze zlym obiektem")); // c1.equals("test ze zlym obiektem" = false
        System.out.println("c1.equals(c2) = " + c1.equals(c2)); // c1.equals(c2) = false
        System.out.println("c1.equals(c3) = " + c1.equals(c3)); // c1.equals(c3) = true
        System.out.println();

//        Metody ustawiające wartości pól:
        c2.setRe(Math.sqrt(-35.2));
        c2.setIm(0.0);
        c3.setRe(0.0 / 0.0);
        c3.setIm(0.0);
        System.out.println("NaN: c2.equals(c3) = " + c2.equals(c3)); // NaN: c2.equals(c3) = true
        System.out.println();
